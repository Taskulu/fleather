...
class _TextFieldScreenState extends State<TextFieldScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: FleatherToolbar.basic(controller: _controller),
      body: Padding(
